...
public class NameResolver implements AST.FullVisitor<Object, NameResolver.Mode> {
	...
	@Override
	public Object visit(UntilStmt untilStmt, Mode arg) {
		if ((untilStmt.condExpr != null) || (!compiler.Compiler.devMode()))
			untilStmt.condExpr.accept(this, arg);
		if ((untilStmt.stmts != null) || (!compiler.Compiler.devMode()))
