...
public class TypeChecker implements AST.FullVisitor<TYP.Type, Mode> {
	...
	@Override
	public TYP.Type visit(AST.UntilStmt untilStmt, Mode arg) {
		Report.warning("HALLO");
		TYP.Type condType = untilStmt.condExpr.accept(this, arg);
		if(!(compTypes(condType, TYP.BoolType.type))){
			throw new Report.Error(untilStmt,"Conditional statement should be of bool");
		}
